<?php
namespace Vendor\PhpAmqpLib\Wire;

use Vendor\PhpAmqpLib\Exception\AMQPInvalidArgumentException;
...
use Vendor\PhpAmqpLib\Exception\AMQPIOWaitException;
use Vendor\PhpAmqpLib\Helper\MiscHelper;
...
class AMQPReader extends AbstractClient
{
     ...
     *
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPIOWaitException
