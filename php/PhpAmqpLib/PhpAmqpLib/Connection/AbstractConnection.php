<?php
namespace Vendor\PhpAmqpLib\Connection;

use Vendor\PhpAmqpLib\Channel\AMQPChannel;
use Vendor\PhpAmqpLib\Channel\AbstractChannel;
use Vendor\PhpAmqpLib\Exception\AMQPProtocolConnectionException;
use Vendor\PhpAmqpLib\Exception\AMQPRuntimeException;
use Vendor\PhpAmqpLib\Exception\AMQPTimeoutException;
use Vendor\PhpAmqpLib\Wire\AMQPReader;
use Vendor\PhpAmqpLib\Wire\AMQPTable;
use Vendor\PhpAmqpLib\Wire\AMQPWriter;
use Vendor\PhpAmqpLib\Wire\IO\AbstractIO;
use Vendor\PhpAmqpLib\Wire\IO\SocketIO;
use Vendor\PhpAmqpLib\Wire\IO\StreamIO;
...
class AbstractConnection extends AbstractChannel
{
    ...
    /** @var \Vendor\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     * @return array
     * @throws \Exception
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPTimeoutException
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPRuntimeException
     */
     ...
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPProtocolConnectionException
     */
    ...
    /**
     * @return \Vendor\PhpAmqpLib\Wire\IO\AbstractIO
     */
