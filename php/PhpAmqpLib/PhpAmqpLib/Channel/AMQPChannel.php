...
use Vendor\PhpAmqpLib\Exception\AMQPBasicCancelException;
use Vendor\PhpAmqpLib\Exception\AMQPProtocolChannelException;
...
class AMQPChannel extends AbstractChannel
{
    ...
    /**
     * @param \Vendor\PhpAmqpLib\Connection\AbstractConnection $connection
    ...
    /**
     * @param AMQPReader $reader
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPProtocolChannelException
     */
    ...
    /**
     * @param AMQPReader $reader
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPBasicCancelException
     */
