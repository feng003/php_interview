<?php
namespace Vendor\PhpAmqpLib\Channel;

use Vendor\PhpAmqpLib\Connection\AbstractConnection;
use Vendor\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Vendor\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use Vendor\PhpAmqpLib\Exception\AMQPRuntimeException;
use Vendor\PhpAmqpLib\Helper\DebugHelper;
use Vendor\PhpAmqpLib\Helper\Protocol\MethodMap080;
use Vendor\PhpAmqpLib\Helper\Protocol\MethodMap091;
use Vendor\PhpAmqpLib\Helper\Protocol\Protocol080;
use Vendor\PhpAmqpLib\Helper\Protocol\Protocol091;
use Vendor\PhpAmqpLib\Helper\Protocol\Wait080;
use Vendor\PhpAmqpLib\Helper\Protocol\Wait091;
use Vendor\PhpAmqpLib\Message\AMQPMessage;
use Vendor\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel
{
    ...
    /** @var \Vendor\PhpAmqpLib\Helper\DebugHelper */
    protected $debug;

    /** @var \Vendor\PhpAmqpLib\Connection\AbstractConnection */
    ...
    /** @var \Vendor\PhpAmqpLib\Helper\Protocol\Protocol080|\Vendor\PhpAmqpLib\Helper\Protocol\Protocol091 */
    protected $protocolWriter;

    /** @var \Vendor\PhpAmqpLib\Helper\Protocol\Wait080|\Vendor\PhpAmqpLib\Helper\Protocol\Wait091 */
    protected $waitHelper;

    /** @var \Vendor\PhpAmqpLib\Helper\Protocol\MethodMap080|\Vendor\PhpAmqpLib\Helper\Protocol\MethodMap091 */
    protected $methodMap;

    /** @var string */
    protected $channel_id;

    /** @var \Vendor\PhpAmqpLib\Wire\AMQPReader */
     ...
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPRuntimeException
     */
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            case self::PROTOCOL_091:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Vendor\PhpAmqpLib\Wire\Constants091';
            ...
            case self::PROTOCOL_080:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Vendor\PhpAmqpLib\Wire\Constants080';
                $c = self::$PROTOCOL_CONSTANTS_CLASS;
                $this->debug = new DebugHelper($c);
                $this->amqp_protocol_header = $c::$AMQP_PROTOCOL_HEADER;
     ...
     * @param \Vendor\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \Vendor\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \Vendor\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \Vendor\PhpAmqpLib\Wire\AMQPWriter
     */
     ...
     * @return \Vendor\PhpAmqpLib\Message\AMQPMessage
     */
     ...
     * @param int $timeout
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPOutOfBoundsException
     * @throws \Vendor\PhpAmqpLib\Exception\AMQPRuntimeException
     * @return mixed
     */
